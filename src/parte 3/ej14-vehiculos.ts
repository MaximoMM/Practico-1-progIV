...
export class Auto extends Vehiculo {
    acelerar(): void {
        console.log(`El auto ${this.marca} ${this.modelo} acelera suavemente.`);
    }
}

export class Moto extends Vehiculo {
    acelerar(): void {
        console.log(`La moto ${this.marca} ${this.modelo} acelera ruidosamente.`);
    }
}

export class Camion extends Vehiculo {
    acelerar(): void {
        console.log(`El camión ${this.marca} ${this.modelo} acelera lentamente con carga.`);
    }
}